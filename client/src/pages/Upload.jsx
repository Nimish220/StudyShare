  ...
  return (
    <main>
      <div className="container" style={{ paddingTop: '2.5rem', paddingBottom: '3rem', maxWidth: '40rem' }}>
        ...
        <p style={{ color: 'var(--muted-foreground)', marginBottom: '2rem' }}>Share your notes, books, or study materials with the community.</p>
        ...
        <form id="upload-form" className="upload-form">
          <div className="upload-zone" id="upload-zone">
            ...
            <input type="file" id="file-input" accept=".pdf,.doc,.docx,.ppt,.pptx,.png,.jpg" hidden />
          </div>

          <div className="form-group" style={{ marginTop: '1.5rem' }}>
            <label htmlFor="title">Title</label>
            <input type="text" id="title" className="form-control" placeholder="e.g. Calculus III Complete Notes" required />
          </div>
          <div className="form-group">
            <label htmlFor="description">Description</label>
            <textarea id="description" className="form-control" rows="4" placeholder="Brief description of the material..."></textarea>
          </div>
          <div className="form-grid-2">
            ...
            <div className="form-group">
              ...
              <input type="text" id="tags" className="form-control" placeholder="e.g. calculus, notes" />
            </div>
          </div>
