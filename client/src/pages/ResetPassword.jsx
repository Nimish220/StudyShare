...
const ResetPassword = () => {
    ...
    const [errors, setErrors] = useState({}); // For red boxes and inline messages
    const [generalMessage, setGeneralMessage] = useState(''); // For server errors
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setGeneralMessage(err.response?.data?.error || "Invalid or expired token");
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px', backgroundColor: '#FCFAF9' }}>
                    ...
                    <div style={{ marginBottom: '20px' }}>
                        ...
                        <div style={{ position: 'relative' }}>
                            <input 
                                ...
                                style={{ 
                                    width: '100%', padding: '12px 45px 12px 12px', borderRadius: '12px', fontSize: '16px',
                                    border: errors.password ? '2px solid #D32F2F' : '1px solid #E8E2E0',
                                    outline: 'none'
                                }}
                                placeholder="••••••••"
                                value={password}
                    ...
                    <div style={{ marginBottom: '30px' }}>
                        ...
                        <div style={{ position: 'relative' }}>
                            <input 
                                ...
                                style={{ 
                                    width: '100%', padding: '12px 45px 12px 12px', borderRadius: '12px', fontSize: '16px',
                                    border: errors.confirmPassword ? '2px solid #D32F2F' : '1px solid #E8E2E0',
                                    outline: 'none'
                                }}
                                placeholder="••••••••"
